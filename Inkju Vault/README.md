...
Prebuilt: **[Inkju-2.1.2-arm64.dmg](https://github.com/royvillasana/inkju/releases/latest)**
...
- **Update notices.** Inkju asks GitHub's releases API whether a newer
...
`--vault <folder>` or set `INKJU_VAULT` to point it somewhere else.
